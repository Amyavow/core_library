...
describe("modules", function () {
	...
	it("should test if modules exist as an Object", function () {
	...
	describe("registerEvent method", function() {
		it("should throw an error if the first argument is not valid object", function() {
			var expectedArgs = function noop(){};

			expect(function(){
				core.registerEvents(expectedArgs, "anymodule")
			}).to.throw()
		})
